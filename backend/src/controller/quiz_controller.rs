...
pub async fn create_quiz(
    ...
    quiz_service::create_quiz(db.get_ref(), body.into_inner()).await
}
...
pub async fn update_quiz(
    ...
    quiz_service::update_quiz(db.get_ref(), path.into_inner(), body.into_inner()).await
}
...
pub async fn delete_quiz(
    ...
    quiz_service::delete_quiz(db.get_ref(), path.into_inner()).await
}

...
pub async fn update_assignment(
    ...
    assignment_service::update_assignment(db.get_ref(), path.into_inner(), body.into_inner()).await
}
...
pub async fn create_assignment(
    ...
    assignment_service::create_assignment(db.get_ref(), body.into_inner()).await
}
...
pub async fn delete_assignment(
    ...
    assignment_service::delete_assignment(db.get_ref(), path.into_inner()).await
}
